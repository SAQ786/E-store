            ...
            <h2>Get In Touch</h2>
	           <div class="status alert alert-success" style="display: none"></div>
                <form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="sendemail.php">
					...
					<div class="form-group col-sm-9">
				        <input type="number_format" name="phone" maxlength="10" size="10" class="form-control" required="required" placeholder="Phone No.">
				    </div>
	       ...
	       <div class="contact-info">
	           <h2 class="title">Contact Info</h2>
	            ...
	            <div><h2 class="title">Follow Us On&#58;</h2>
                   <a href="https://www.facebook.com/absar.qureshi.165" target="_blank"><img src="./img/logofb.png" alt="fb logo" style="width:30px; height:30px; border:0"></a>
                   <a href="https://twitter.com/AbsarQureshi10" target="_blank"><img src="./img/logotwitter.png" alt="twitter logo" style="width:30px; height:30px; border:0 padding-left:10px;"></a>
               </div>
            </div>
        </div>
    </div>
